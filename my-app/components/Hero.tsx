...
const Hero = (props: Props) => {
  return (
    <motion.div className=" h-screen w-full flex flex-col-reverse items-center justify-center bg-[#D4D7E1] [#EF7A0E] xl:flex-row xl:pb-40">
      {/* Left Hero Section */}
      ...
      <div className=" relative flex w-full h-screen items-center justify-center xl:w-[50%] xl:h-[80%]">
        <Image
          ...
          alt=""
        />
        <div className="h-[40px] w-[40px] rounded-full absolute border-2 border-[#EF7A0E] top-10 sm:top-20 right-20 md:top-40 md:right-40 md:w-[60px] md:h-[60px]"></div>
