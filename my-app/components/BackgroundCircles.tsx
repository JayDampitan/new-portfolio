...
const BackgroundCircles = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#333333] rounded-full h-[400px] w-[400px] xl:h-[600px] xl:w-[600px]    animate-ping" />
      <div className="absolute border border-[#c8aa6a] rounded-full opacity-20  h-[600px] w-[600px] xl:h-[750px] xl:w-[750px]   animate-pulse" />
